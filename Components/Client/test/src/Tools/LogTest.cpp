...
static void initLogger()
{
    ...
    if (!isInit)
    {
        cash::tool::log::initialize(std::string(UTWorkDirectory) + "/utLog", plog::debug, plog::debug);
        isInit = true;
    }
}
...
TEST (Log, simpleLogOnConsole)
{
    ...
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "simpleLogOnConsole test.";
...
TEST (Log, multiLogOnConsole)
{
    ...
    testing::internal::CaptureStdout();
    testing::internal::CaptureStderr();
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "multiLogOnConsole.0 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "multiLogOnConsole.1 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "multiLogOnConsole.2 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "multiLogOnConsole.3 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "multiLogOnConsole.4 test.";
    outStdout = testing::internal::GetCapturedStdout();
    outStderr = testing::internal::GetCapturedStderr();
    EXPECT_TRUE(outStderr.empty());
...
TEST (Log, multiLogOnConsoleWithDiffSeverity)
{
    ...
    testing::internal::CaptureStdout();
    testing::internal::CaptureStderr();
    LOG_(cash::tool::log::IN_CONSOLE, plog::fatal) << "multiLogOnConsoleWithDiffSeverity.0 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "multiLogOnConsoleWithDiffSeverity.1 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "multiLogOnConsoleWithDiffSeverity.2 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::fatal) << "multiLogOnConsoleWithDiffSeverity.3 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::error) << "multiLogOnConsoleWithDiffSeverity.4 test.";
    outStdout = testing::internal::GetCapturedStdout();
    outStderr = testing::internal::GetCapturedStderr();
    EXPECT_TRUE(outStderr.empty());
...
TEST (Log, multiLogOnConsoleWithLockedSeverity)
{
    ...
    testing::internal::CaptureStdout();
    testing::internal::CaptureStderr();
    LOG_(cash::tool::log::IN_CONSOLE, plog::verbose) << "multiLogOnConsoleWithLockedSeverity.0 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "multiLogOnConsoleWithLockedSeverity.1 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::verbose) << "multiLogOnConsoleWithLockedSeverity.2 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::fatal) << "multiLogOnConsoleWithLockedSeverity.3 test.";
    LOG_(cash::tool::log::IN_CONSOLE, plog::error) << "multiLogOnConsoleWithLockedSeverity.4 test.";
    outStdout = testing::internal::GetCapturedStdout();
    outStderr = testing::internal::GetCapturedStderr();
    EXPECT_TRUE(outStderr.empty());
...
TEST (Log, emptyMessageOnConsole)
{
    ...
    testing::internal::CaptureStdout();
    testing::internal::CaptureStderr();
    LOG_(cash::tool::log::IN_CONSOLE, plog::warning) << "";
    outStdout = testing::internal::GetCapturedStdout();
    outStderr = testing::internal::GetCapturedStderr();
    EXPECT_TRUE(outStderr.empty());
...
TEST (Log, falseSeverityOnConsole)
{
    ...
    testing::internal::CaptureStdout();
    testing::internal::CaptureStderr();
    LOG_(cash::tool::log::IN_CONSOLE, static_cast<plog::Severity>(845)) << "falseSeverityOnConsole";
    outStdout = testing::internal::GetCapturedStdout();
    outStderr = testing::internal::GetCapturedStderr();
    EXPECT_TRUE(outStderr.empty());
...
TEST (Log, simpleLogOnFile)
{
    ...
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "simpleLogOnFile test.";
...
TEST (Log, multiLogOnFile)
{
    ...
    initLogger();
    system(std::string(std::string("echo -n "" > ") + UTWorkDirectory + "/utLog").c_str());
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "multiLogOnFile.0 test.";
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "multiLogOnFile.1 test.";
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "multiLogOnFile.2 test.";
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "multiLogOnFile.3 test.";
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "multiLogOnFile.4 test.";
...
TEST (Log, multiLogOnFileWithDiffSeverity)
{
    ...
    initLogger();
    system(std::string(std::string("echo -n "" > ") + UTWorkDirectory + "/utLog").c_str());
    LOG_(cash::tool::log::IN_FILE, plog::fatal) << "multiLogOnFileWithDiffSeverity.0 test.";
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "multiLogOnFileWithDiffSeverity.1 test.";
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "multiLogOnFileWithDiffSeverity.2 test.";
    LOG_(cash::tool::log::IN_FILE, plog::fatal) << "multiLogOnFileWithDiffSeverity.3 test.";
    LOG_(cash::tool::log::IN_FILE, plog::error) << "multiLogOnFileWithDiffSeverity.4 test.";
    content = readFile(std::string(UTWorkDirectory) + "/utLog");
...
TEST (Log, multiLogOnFileWithLockedSeverity)
{
    ...
    initLogger();
    system(std::string(std::string("echo -n "" > ") + UTWorkDirectory + "/utLog").c_str());
    LOG_(cash::tool::log::IN_FILE, plog::verbose) << "multiLogOnFileWithLockedSeverity.0 test.";
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "multiLogOnFileWithLockedSeverity.1 test.";
    LOG_(cash::tool::log::IN_FILE, plog::verbose) << "multiLogOnFileWithLockedSeverity.2 test.";
    LOG_(cash::tool::log::IN_FILE, plog::fatal) << "multiLogOnFileWithLockedSeverity.3 test.";
    LOG_(cash::tool::log::IN_FILE, plog::error) << "multiLogOnFileWithLockedSeverity.4 test.";
    content = readFile(std::string(UTWorkDirectory) + "/utLog");
...
TEST (Log, emptyMessageOnFile)
{
    ...
    initLogger();
    system(std::string(std::string("echo -n "" > ") + UTWorkDirectory + "/utLog").c_str());
    LOG_(cash::tool::log::IN_FILE, plog::warning) << "";
    content = readFile(std::string(UTWorkDirectory) + "/utLog");
...
TEST (Log, falseSeverityOnFile)
{
    ...
    initLogger();
    system(std::string(std::string("echo -n "" > ") + UTWorkDirectory + "/utLog").c_str());
    LOG_(cash::tool::log::IN_FILE, static_cast<plog::Severity>(845)) << "falseSeverityOnFile";
    content = readFile(std::string(UTWorkDirectory) + "/utLog");
